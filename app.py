...
# Streamlit UI setup
st.set_page_config(
    page_title="LegalBot - Legal Assistant", 
    page_icon="⚖️",
    layout="wide"
)
...
with col2:
    ...
    st.markdown("""
        <div style='text-align: center; padding: 20px;'>
            ...
            <h1 style='margin: 0; color: #1f4e79; font-family: serif;'>LegalBot</h1>
...
st.markdown("""
    <div style='text-align: center; padding: 20px; color: #666; font-size: 0.9rem;'>
        <p style='margin: 0;'>⚖️ <strong>LegalBot</strong> - Powered by AI Technology</p>
