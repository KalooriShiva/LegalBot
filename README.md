...
**Try it now**: [https://LegalBot-legal-chatbot.streamlit.app/](https://LegalBot-legal-chatbot.streamlit.app/)

## 🎥 Demo Video

Watch LegalBot in action:

https://github.com/user-attachments/assets/85481859-9231-4636-9582-83810ac6634d
...
2. **Clone & Setup**:
   ```bash
   git clone https://github.com/KalooriShiva/LegalBot.git
   cd LegalBot-Legal-Chatbot
   python3 -m venv .venv
